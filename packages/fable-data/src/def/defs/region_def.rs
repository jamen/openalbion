...
def_struct! {
    ...
    pub struct RegionDef {
        ...
        "InternalLightingChannelCount" => pub internal_lighting_channel_count: i32,
        ...
        "InBuildingOcclusionLevel" => pub in_building_occlusion_level: f32,
        "UseVillageTime" => pub use_village_time: bool,
        "AllowHenchmen" => pub allow_henchmen: bool,
        ...
        "MaxNumAttackersOnHero" => pub max_num_attackers_on_hero: i32,
        "CameraManagerSetIndex" => pub camera_manager_set_index: i32,
        "CameraManagerSetBuildingIndex" => pub camera_manager_set_building_index: i32,
        ...
        "LockToFrameRate" => pub lock_to_frame_rate: i32,
