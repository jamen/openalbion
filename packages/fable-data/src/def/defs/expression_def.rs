...
def_struct! {
    ...
    pub struct ExpressionDef {
        ...
        "ScriptLoadResources" => pub script_load_resources: bool = true,
        "DeactivateScriptAtEnd" => pub deactivate_script_at_end: bool = true,
        ...
        "ReplaceHeldItemWhenDone" => pub replace_held_item_when_done: bool = true,
