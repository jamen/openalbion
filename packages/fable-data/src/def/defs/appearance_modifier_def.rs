...
def_struct! {
    ...
    pub struct AppearanceModifierDef {
        ...
        "IsRemoveable" => pub is_removeable: bool,
        ...
        "SoundRadiusMultiplier" => pub sound_radius_multiplier: f32,
        "VisibilityMultiplier" => pub visibility_multiplier: f32,
        "ArmourDefIndex" => pub armour_def_index: i32,
