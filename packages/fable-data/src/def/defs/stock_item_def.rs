...
def_struct! {
    ...
    pub struct StockItemDef {
        ...
        "DefaultIsStealable" => pub default_is_stealable: bool,
        ...
        "ChanceOfBecomingAvailable" => pub chance_of_becoming_available: f32,
        "CanBeDisplayedInShop" => pub can_be_displayed_in_shop: bool,
    }
}
