...
def_struct! {
    ...
    pub struct SpecialAbilitiesUnholyPowerDef {
        ...
        "RandomFactorForNumSecsBetweenDamageHit" => pub random_factor_for_num_secs_between_damage_hit: f32,
        ...
        "VelocityOfLift" => pub velocity_of_lift: f32,
        "DistanceToLift" => pub distance_to_lift: f32,
