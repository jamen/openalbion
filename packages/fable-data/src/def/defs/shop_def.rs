...
def_struct! {
    ...
    pub struct ShopDef {
        ...
        "BuyPriceMultiplier" => pub buy_price_multiplier: f32 = 1.0,
        "SellPriceMultiplier" => pub sell_price_multiplier: f32 = 1.0,
        "AttitudeBuyPriceMultiplierDefault" => pub attitude_buy_price_multiplier_default: f32 = 1.0,
        "AttitudeBuyPriceMultiplier" => pub attitude_buy_price_multiplier: VecMap<Opinion, f32>,
        "AttitudeSellPriceMultiplierDefault" => pub attitude_sell_price_multiplier_default: f32 = 1.0,
        ...
        "MaxStockRevertPerDay" => pub max_stock_revert_per_day: f32 = 1.0,
        "PriceReductionFractionPerItem" => pub price_reduction_fraction_per_item: f32,
        "MaxPriceReductionFractionDueToStockCount" => pub max_price_reduction_fraction_due_to_stock_count: f32 = 0.6,
        "IsStockDisplayPermanent" => pub is_stock_display_permanent: bool = true,
        ...
        "MinPriceMultiplierForItemToBeWanted" => pub min_price_multiplier_for_item_to_be_wanted: f32 = 1.1,
