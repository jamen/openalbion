...
def_struct! {
    ...
    pub struct ShopDef {
        ...
        "AttitudeBuyPriceMultiplier" => pub attitude_buy_price_multiplier: VecMap<f32, Opinion>,
        "AttitudeSellPriceMultiplierDefault" => pub attitude_sell_price_multiplier_default: f32,
        "AttitudeSellPriceMultiplier" => pub attitude_sell_price_multiplier: VecMap<f32, Opinion>,
