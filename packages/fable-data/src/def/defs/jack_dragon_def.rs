...
def_struct! {
    ...
    pub struct JackDragonDef {
        ...
        "PercentChanceOfFakeLandingSwoop" => pub percent_chance_of_fake_landing_swoop: f32,
        ...
        "FramesBetweenFireBeamUpdate" => pub frames_between_fire_beam_update: i32,
        "FramesBetweenBurninateUpdate" => pub frames_between_burninate_update: i32,
        "HoverObstructionRadius" => pub hover_obstruction_radius: f32,
        "StrafeTriggerDistance" => pub strafe_trigger_distance: f32,
