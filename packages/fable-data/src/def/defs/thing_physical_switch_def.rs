...
def_struct! {
    /// `PHYSICAL_SWITCH` — C++ `CThingPhysicalSwitchDef`.
    ...
    pub struct ThingPhysicalSwitchDef {
        ...
        "TriggerType" => pub trigger_type: PSwitchTriggerType,
        "UntriggeredGraphic" => pub untriggered_graphic: EngineGraphic,
        "TriggeredGraphic" => pub triggered_graphic: EngineGraphic,
        "TriggerSound" => pub trigger_sound: i32,
    }
}
