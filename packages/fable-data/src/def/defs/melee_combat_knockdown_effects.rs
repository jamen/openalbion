...
def_struct! {
    ...
    pub struct MeleeCombatKnockdownEffects {
        ...
        "AttackerLightingChannel" => pub attacker_lighting_channel: i32 = -1,
        "TargetLightingChannel" => pub target_lighting_channel: i32 = -1,
        "EnvironmentTheme" => pub environment_theme: i32 = -1,
        "CameraFOVChange" => pub camera_fov_change: bool,
        "CameraPan" => pub camera_pan: bool,
        "AttackerAndTargetSpeedMultiplier" => pub attacker_and_target_speed_multiplier: f32 = -1.0,
