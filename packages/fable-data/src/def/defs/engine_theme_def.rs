...
def_struct! {
    ...
    pub struct EngineThemeDef {
        ...
        "MaterialDef" => pub material_def: DefIndex,
        "MinimapTheme" => pub minimap_theme: MinimapThemeType,
        "LocalDetailGeneratorDef" => pub local_detail_generator_def: DefIndex,
        "DestructionEffectDef" => pub destruction_effect_def: DefIndex,
        "DestructionThemeDef" => pub destruction_theme_def: DefIndex,
        "Friction" => pub friction: f32 = 1.0,
        "WaterHeight" => pub water_height: f32,
        "WaterType" => pub water_type: WaterType,
        "NoWaterThemeDef" => pub no_water_theme_def: DefIndex,
