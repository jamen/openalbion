...
def_struct! {
    ...
    pub struct WeaponDef {
        ...
        "AnimationGroup" => pub animation_group: String,
        ...
        "ProjectileWeaponHelperNameTip" => pub projectile_weapon_helper_name_tip: String,
        "ProjectileWeaponHelperNameBase" => pub projectile_weapon_helper_name_base: String,
        ...
        "MeleeTargetingArc" => pub melee_targeting_arc: f32,
        "NeedsLoading" => pub needs_loading: bool,
