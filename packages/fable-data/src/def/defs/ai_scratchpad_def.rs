...
def_struct! {
    ...
    pub struct AIScratchpadDef {
        ...
        "CombatNearbyEnemyFleeingBreakOffRange" => pub combat_nearby_enemy_fleeing_break_off_range: f32 = 5.0,
        "CombatNearbyBreakOffRange" => pub combat_nearby_break_off_range: f32 = 10.0,
        ...
        "KillSelfAndStealableItemAfterReachingDestination" => pub kill_self_and_stealable_item_after_reaching_destination: bool = true,
        "AllowedToFollow" => pub allowed_to_follow: bool = true,
        "TableName" => pub table_name: String,
        "SeatName" => pub seat_name: String,
        "DisableHeadLooking" => pub disable_head_looking: bool,
        "IsPushableByHero" => pub is_pushable_by_hero: bool = true,
        "LookForFiniteTime" => pub look_for_finite_time: bool = true,
        "AvoidRegionExits" => pub avoid_region_exits: bool = true,
