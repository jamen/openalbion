...
def_struct! {
    ...
    pub struct MeleeCombatAbilityDef {
        ...
        "DamageMultiplier" => pub damage_multiplier: f32 = 1.0,
        ...
        "KnockDownEffects" => pub knock_down_effects: i32 = -1,
        ...
        "ComboMultiplierLowerBound" => pub combo_multiplier_lower_bound: i32 = -1,
        "ComboMultiplierUpperBound" => pub combo_multiplier_upper_bound: i32 = -1,
    }
}
