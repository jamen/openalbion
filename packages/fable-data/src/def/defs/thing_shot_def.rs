...
def_struct! {
    ...
    pub struct ThingShotDef {
        ...
        "CauseDamage" => pub cause_damage: bool = true,
        ...
        "ExplosionDef" => pub explosion_def: DefIndex = DefIndex(-1),
        "GroundExplosionDef" => pub ground_explosion_def: DefIndex = DefIndex(-1),
        "ObjectDef" => pub object_def: DefIndex,
        ...
        "MeleeHitDeflectionDamageMultiplier" => pub melee_hit_deflection_damage_multiplier: f32 = 1.0,
        "FaceMovementDirection" => pub face_movement_direction: bool = true,
        "AllowDeflections" => pub allow_deflections: bool,
        "BounceOnGround" => pub bounce_on_ground: bool,
        "Bounciness" => pub bounciness: f32 = 1.0,
        "RotateOnDeflection" => pub rotate_on_deflection: bool = true,
        "IsBlockable" => pub is_blockable: bool = true,
        "DamageType" => pub damage_type: DamageAttribute = DamageAttribute::PROJECTILE,
        "NumSubShots" => pub num_sub_shots: i32,
        "SubShotType" => pub sub_shot_type: DefIndex = DefIndex(-1),
        "SubShotCreationTime" => pub sub_shot_creation_time: f32 = 1.0,
        "SubShotMaxAngle" => pub sub_shot_max_angle: f32 = 0.125,
        "RemoveMainShotOnSubShotCreation" => pub remove_main_shot_on_sub_shot_creation: bool = true,
        "DoesExplosionDamageCaster" => pub does_explosion_damage_caster: bool = true,
