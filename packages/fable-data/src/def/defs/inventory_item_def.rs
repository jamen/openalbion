...
def_struct! {
    ...
    pub struct InventoryItemDef {
        ...
        "InventoryType" => pub inventory_type: i32 = 17,
        "Orientation" => pub orientation: i32,
        "HeroAbilityDef" => pub hero_ability_def: i32,
        "IsSellable" => pub is_sellable: bool = true,
        "IsBuyable" => pub is_buyable: bool = true,
        "IsConfiscatable" => pub is_confiscatable: bool = true,
        ...
        "UIInventoryCategory" => pub ui_inventory_category: i32 = 4,
    }
}
