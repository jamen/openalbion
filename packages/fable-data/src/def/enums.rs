...
/// Returns a static set of all known C++ enumerator symbol names from all
/// DefEnum and DefFlags types. Used by the analysis pass to suppress
/// spurious "unresolved identifier" warnings for enum variants.
#[must_use]
pub fn all_enum_symbols() -> &'static HashSet<&'static str> {
    static SET: OnceLock<HashSet<&'static str>> = OnceLock::new();
    SET.get_or_init(|| {
        let mut s = HashSet::new();
        s.extend(ActionRegisteredType::all_symbols());
        s.extend(ActionType::all_symbols());
        s.extend(ClockHandType::all_symbols());
        s.extend(ClothingSuitPart::all_symbols());
        s.extend(CombatCreatureType::all_symbols());
        s.extend(CombatSequenceInterruptionType::all_symbols());
        s.extend(CombatSequenceIsValidType::all_symbols());
        s.extend(CombatSequenceOnStartModuleType::all_symbols());
        s.extend(CombatSequenceOnStopModuleType::all_symbols());
        s.extend(CombatSequenceType::all_symbols());
        s.extend(CombatStrikeRecoilStyle::all_symbols());
        s.extend(CompositeBlendType::all_symbols());
        s.extend(ContextSensitiveType::all_symbols());
        s.extend(ControlledMovementType::all_symbols());
        s.extend(ControllerType::all_symbols());
        s.extend(CreatureAbility::all_symbols());
        s.extend(CreatureGeneratorGenerateType::all_symbols());
        s.extend(CreatureType::all_symbols());
        s.extend(CrimeSeverity::all_symbols());
        s.extend(DamageAttribute::all_symbols());
        s.extend(DialogueLayer::all_symbols());
        s.extend(DoorTriggerType::all_symbols());
        s.extend(EngineGraphicType::all_symbols());
        s.extend(ExpressionInventoryType::all_symbols());
        s.extend(FeatAttackType::all_symbols());
        s.extend(GameAction::all_symbols());
        s.extend(GameEventType::all_symbols());
        s.extend(GiftType::all_symbols());
        s.extend(HeroAbility::all_symbols());
        s.extend(HeroAttachableAppearanceModifierType::all_symbols());
        s.extend(HeroExperienceStatCategory::all_symbols());
        s.extend(HeroTitle::all_symbols());
        s.extend(HeroTrainingStatus::all_symbols());
        s.extend(InputKey::all_symbols());
        s.extend(LightingChannel::all_symbols());
        s.extend(MessageEventType::all_symbols());
        s.extend(MinimapThemeType::all_symbols());
        s.extend(MouseButtonControl::all_symbols());
        s.extend(NavigatorType::all_symbols());
        s.extend(NoiseType::all_symbols());
        s.extend(PerceivedThingType::all_symbols());
        s.extend(PointLightChannelEffect::all_symbols());
        s.extend(QuakeLength::all_symbols());
        s.extend(QuakeStrength::all_symbols());
        s.extend(ReactionSpeechType::all_symbols());
        s.extend(ReverbEnvironmentType::all_symbols());
        s.extend(ScriptingStateGroups::all_symbols());
        s.extend(Sex::all_symbols());
        s.extend(StateChangeType::all_symbols());
        s.extend(TableSprites::all_symbols());
        s.extend(TavernGameControlType::all_symbols());
        s.extend(TextAlignment::all_symbols());
        s.extend(ThingCreatureProperty::all_symbols());
        s.extend(TrapTriggerType::all_symbols());
        s.extend(TrapType::all_symbols());
        s.extend(TutorialCategory::all_symbols());
        s.extend(UiType::all_symbols());
        s.extend(WallMountEffects::all_symbols());
        s.extend(WaterType::all_symbols());
        s.extend(WeaponClass::all_symbols());
        s.extend(WeaponType::all_symbols());
        s.extend(XboxControllerButton::all_symbols());
        s.extend(CreatureInteractionType::all_symbols());
        s.extend(IdleStateGroup::all_symbols());
        s.extend(ObjectAugmentationType::all_symbols());
        s.extend(Opinion::all_symbols());
        s.extend(OpinionAttitudeType::all_symbols());
        s.extend(OpinionDeedType::all_symbols());
        s.extend(OpinionReactionType::all_symbols());
        s.extend(OpinionTargetingConditionType::all_symbols());
        s.extend(PSwitchTriggerType::all_symbols());
        s.extend(Sprite2dFlags::all_symbols());
        s.extend(SwitchTriggerType::all_symbols());
        s.extend(TableExpansion::all_symbols());
        s.extend(WorldMapNameGraphic::all_symbols());
        s
    })
}
